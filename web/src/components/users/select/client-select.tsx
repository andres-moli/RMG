...
import { Client, useClientsQuery, useUsersQuery } from "../../../domain/graphql";  // Asegúrate de importar correctamente tu consulta de GraphQL
...
const ClientSelect: React.FC<UserSelectProps> = ({ onSelect, clear }) => {
  ...
  return (
    <div className="user-select-container">
      <label htmlFor="user" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Cliente</label>
      <select
        name="user"
        id="user"
        value={selectUser}
