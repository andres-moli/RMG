...
import { MetadataPagination, OrderTypes, Products, useProductsQuery, User, UserStatusTypes, useUsersQuery } from '../../../domain/graphql';
  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <tbody>
          ...
          data?.Products.map((product, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">{formatCurrency(product.costPrice || 0)}</td>
                <td className="px-6 py-4">{product.isActive ? 'ACTIVO' : 'INACTIVO'}</td>
                <td className="px-6 py-4">{product.stock.stock}</td>
      ...
      <Card className="w-50 md:w-30 lg:w-50">
        <PaginationTable skipState={{ value: skip, setValue: setSkip }} metaDataPagination={data?.ProductsCount as MetadataPagination} takeValue={takeValue} />
      </Card>
      <EditModalProducts
