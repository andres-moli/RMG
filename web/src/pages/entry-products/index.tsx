...
const ProductsEntryPage: React.FC = () => {
    ...
    <MainLayout>
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center w-full">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Entrada Productos</h1>
            <h3 className="text-lg font-medium text-gray-600 dark:text-gray-400">Gestiona tus entrada de productos</h3>
          </div>
          <button
...
export default ProductsEntryPage;
