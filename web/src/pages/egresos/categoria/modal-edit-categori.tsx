...
import { CategoryExpenses, StatusCategoryExpenses, useCreateCategoryExpenseMutation, useCreateProductMutation, useUpdateCategoryExpenseMutation } from "../../../domain/graphql";
...
interface RegisterModalProps {
  isOpen: boolean;
  onClose: () => void;
  category: CategoryExpenses | undefined
}
const EditModalCategory: React.FC<RegisterModalProps> = ({ isOpen, onClose, category }) => {
  if(!category) return
  const [update] = useUpdateCategoryExpenseMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const toatsId = toast.loading('Actualizando categoria de gasto..')
    try {
      ...
      toast.success('Categoria de gasto actualizada...');
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              ...
              {
                Object.values(StatusCategoryExpenses).map((id)=> {
                  return (
