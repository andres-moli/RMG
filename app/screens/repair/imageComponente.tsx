...
const ImageField = ({ field, value, onChange }: { field: any, value: string, onChange: (val: string) => void }) => {
    ...
    <Card style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <TouchableOpacity onPress={() => setIsVisible(!isVisible)}>
          <MaterialCommunityIcons name={isVisible ? "eye-off" : "eye"} size={24} color="black" />
        </TouchableOpacity>
      </View>
