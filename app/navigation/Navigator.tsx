...
import StepProgress from '../screens/Add/AddScreen';
      ...
      options={{
        ...
        tabBarButton: (props) => (
          <CustomTabBarButton {...props}>
            <MaterialCommunityIcons name="qrcode-scan" size={sizeIcono} color="white" />
          </CustomTabBarButton>
        ),
        // headerLeft(props) {
        //   return (
