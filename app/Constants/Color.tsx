...
const ColorPaletteBlack: ColorPalette = {
  primary: "#000000", // Negro como color principal
  darkGray: "#212121", // Gris oscuro más profundo para contraste sin ser tan duro
  white: "#FFFFFF", // Blanco para textos y detalles
  softYellow: "#F1D00A", // Amarillo suave pero más vibrante para resaltar sin ser demasiado brillante
  coral: "#FF5B5B", // Coral más suave y elegante para botones o llamadas a la acción
  lightPink: "#2C3E50", // Rosa pastel suave que complementa el coral sin recargar
  lightBeige: "#F7F7F7" // Beige cálido, para fondos suaves pero que contrasten con el negro
};
